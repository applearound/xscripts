...
class PermittedSubclassesAttributeInfo(AttributeInfo):
    ...
    def __init__(self, raw_bytes: bytes, attribute_name_index: int, attribute_length: int) -> None:
        ...
        self.number_of_classes: int = self.parse_int(self.__raw[6:8])
        self.classes: bytes = self.__raw[8:]
    ...
    def __repr__(self) -> str:
        return f"PermittedSubclassesAttribute(name_index={self.attribute_name_index}, length={self.attribute_length}, " \
