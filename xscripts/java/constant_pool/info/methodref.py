...
class MethodrefConstantPoolInfo(ConstantPoolInfo):
    """ Represents a Methodref constant pool entry in a Java class file.
    ...
    def get_tag() -> ConstantPoolInfoTags:
        return ConstantPoolInfoTags.METHODREF
    ...
    def class_index(self) -> int:
        """ Get the class index of the method reference.
        """
        return self.parse_int(self.raw[1:3])

    @cached_property
    def name_and_type_index(self) -> int:
        """ Get the name and type index of the method reference.
        """
